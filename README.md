...
## Environments
- Preview: https://main--setup4-ue-extension--lovelymandal16.hlx.page/
- Live: https://main--setup4-ue-extension--lovelymandal16.hlx.live/
...
1. Open the `setup4-ue-extension` directory in your favorite IDE and start coding :)
